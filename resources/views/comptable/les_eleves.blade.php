            ...
            <div class="modal-content">
                ...
                <form action="{{ route('eleves.store') }}" method="POST" enctype="multipart/form-data">@csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group"><label class="form-label">Date de naissance</label><input type="date"
                                name="date_n" class="form-control-modern"></div>
                        ...
                        <div class="form-group"><label class="form-label">Téléphone responsable</label><input
                                name="tel_responsable" class="form-control-modern"></div>
                        <div class="form-group"><label class="form-label">Adresse</label>
                            <textarea name="adresse" class="form-control-modern"></textarea>
                        </div>
                        <div class="form-group"><label class="form-label">École de provenance</label><input
                                name="ecole_provenance" class="form-control-modern"></div>
