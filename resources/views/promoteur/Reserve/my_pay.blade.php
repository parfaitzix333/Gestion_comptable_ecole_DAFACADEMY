                                    ...
                                    <td>
                                                ...
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <button class="btn btn-primary text-light  no-print"
                                                            onclick="imprimerFacture({{ $p->id }})">Imprimer</button>
                                        ...
                                        <style>
                                            ...
                                            @media print {
                                                ...
                                                body.facture-en-impression .zoneAimprimer.active,
                                                body.facture-en-impression .zoneAimprimer.active * {
                                        ...
                                        <script>
                                            function imprimerFacture(paiementId) {
                                                ...
                                                document.querySelectorAll('.zoneAimprimer').forEach(function(zone) {
                                                    zone.classList.remove('active');
                                                });

                                                const facture = document.getElementById('zoneAimprimer' + paiementId);
                                                ...
                                                document.body.classList.add('facture-en-impression');
                                            ...
                                            window.addEventListener('afterprint', function() {
                                                ...
                                                document.body.classList.remove('facture-en-impression');
