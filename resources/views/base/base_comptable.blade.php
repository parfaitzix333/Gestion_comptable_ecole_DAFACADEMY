...
<html lang="fr">
    ...
    ========================================================== -->
        ...
        <nav class="main-nav">
            ...
            <a href="{{ route('profile_comptable') }}"
                class="nav-item {{ request()->routeIs('profile_comptable') ? 'active' : '' }}">
                <i class="fas fa-home"></i>
                <span>Accueil</span>
            </a>


            <a href="{{ route('les_paiements_comptable') }}"
                class="nav-item {{ request()->routeIs('les_paiements_comptable') ? 'active' : '' }}">
                <i class="fas fa-credit-card"></i>
                <span>Paiements</span>
            </a>

            <a href="{{ route('les_eleve_comptable') }}"
                class="nav-item {{ request()->routeIs('les_eleve_comptable') ? 'active' : '' }}">
                <i class="fas fa-user-graduate"></i>
                <span>Élèves</span>
                <span class="badge bg-danger">
                    {{ App\Models\Eleve::where('annee_scolaire_id', $user->anne_scolaire_id)->count() }}
                </span>
            </a>

            <a href="{{ route('edit_profile_compt') }}"
                class="nav-item {{ request()->routeIs('edit_profile_compt') ? 'active' : '' }}">
                <i class="fas fa-user-graduate"></i>
