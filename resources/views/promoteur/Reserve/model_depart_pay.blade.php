            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                ...
                <div>
                    <button class="btn-modern btn-primary-modern" data-bs-toggle="modal"
                        data-bs-target="#createPaiementGlobalModal">
                                            ...
                                            <td>
                                                @forelse ($fraisEleve as $frais)
                                                    @php
                                                        ...
                                                        $estAcompte =
                                                            $paiementExiste && $paiementExiste->statut === 'acompte';
                                                        $montantPaye = $paiementExiste ? $paiementExiste->montant : 0;
                                                    @endphp
                                                    <span
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="action-buttons">
                                            ...
                                            <button data-bs-target="#zoneAimprimer{{ $p->id }}"
                                                onclick="window.print()" class="btn btn-secondary"><small>Facture</small>
                                            </button>
                                        </div>
                                        ...
                                        <div class="zoneAimprimer" id="zoneAimprimer{{ $p->id }}">
                                            ...
                                            <div id="EnteteFacture" class="d-flex items-justify-content">
                                                ...
                                                <img src="{{ asset('image/logo.jpeg') }}" alt="factureLogo"
                                                ...
                                                <div class="border border-1 border-primary ms-4 p-3" id="num_recu">
                                                    <h2 class=""><strong class="text-dark">RECU N°: <br>
                                            ...
                                            <div class="border border-1 border-primary mt-2">
                                                <table class="table table-striped">
                                                    <tr>
                                                        ...
                                                        <td colspan="2">{{ $p->eleve->nom ?? '--' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bg-dark text-light">Classe</td>
                                                        <td colspan="2">{{ $p->classe->designation ?? '--' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="bg-dark text-light">Matricule</td>
                                                        <td class="bg-dark text-light">Montant</td>
                                                        <td class="bg-dark text-light" colspan="2">Montant en lettre
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>{{ $p->eleve->matricule ?? '--' }}</td>
                                                        <td>{{ $p->devise }} {{ number_format($p->montant, 2) }}</td>
                                                        <td colspan="2"><i>{{ $p->montant_en_lettre ?? '--' }}</i></td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="3" class="bg-dark text-light text-center">MODE DE
                                                            PAIEMENT</td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                ...
                                                <div>
                                                    ...
                                                    <strong>Email: {{ $contacts->couriel ?? '--' }}</strong>
                                                </div>
                                            </div>
